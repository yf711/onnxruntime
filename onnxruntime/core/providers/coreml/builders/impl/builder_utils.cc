...
void AddOperationOutput(COREML_SPEC::MILSpec::Operation& op, const std::string& name,
  ...
  SetTensorTypeInfo(tensor_type, OnnxDataTypeToMILSpec(element_type),
                    shape, /*convert_scalar*/ true);
}
